...
class MFGCN(nn.Module):
    ...
    def forward(self,
        ...
        # emb=torch.stack([outputs_l,outputs_n,MFF],dim=1)
        # emb_last, att_all_nterview = self.attention(emb)
        # return outputs_n, feat_orig, embeddings_orig, outputs_l, outputs_n, MFF, emb_last
